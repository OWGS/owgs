<!-- Introduction Row -->
        <div class="row">
            <div class="col-lg-12">
				...
				<input type="text" name="name" class="form-control" placeholder="Name" required="true" onkeypress="return textonly(event);"/><br />
				<input type="text" name="vorname" class="form-control" placeholder="Vorname" required="true" onkeypress="return textonly(event);"/><br>
				...
				<input type="text" name="ort" class="form-control" placeholder="Ort" required="true" onkeypress="return textonly(event);"/><br>
