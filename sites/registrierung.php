                ...
                <h1 class="page-header">Registrierung
					...
					if (isset($_GET['fail']) && $_GET['fail'] == 1){
		 			?>			
						...
						<input type="text" name="username" class="form-control" placeholder="Bitte einen anderen Username wählen" required="true" /><br>
						<input type="email" name="email" class="form-control" value="<?php echo $_SESSION['email'];?>" required="true" /><br>
						...
						<input type="text" name="name" class="form-control" value="<?php echo $_SESSION['name'];?>" required="true" onkeypress="return onlyText(event);"/><br />
						<input type="text" name="vorname" class="form-control" value="<?php echo $_SESSION['vorname'];?>" required="true" onkeypress="return onlyText(event);"/><br>
						<input type="text" name="adresse" class="form-control" value="<?php echo $_SESSION['adresse'];?>" /><br>
