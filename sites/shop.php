<div class="row">
	...
	<div class="col-lg-4 col-sm-6">
		<h5>Platform:</h5>
			<input type="hidden" name="site" value="shop" >
			<?php 
				require_once("sql/select_games.php"); 
				while($platform = $result_all_platforms->fetch_assoc()) {
			?>
			<div class="radio">
				<label>
	...
	<div class="col-lg-4 col-sm-6">
			<h5>Kategorie:</h5>
			<?php
				while($kategorie = $result_all_kategories->fetch_assoc()) {
			?>
			<div class="radio">
				<label>
	...
	<div class="col-lg-12">
			<input type="submit" name="submit" value="Filter", class="btn btn-lg btn-primary btn-block" />
		</form>
	</div>
