...
<div class="row" xmlns="http://www.w3.org/1999/html">
    ...
    <a class="btn btn-lg btn-primary" data-toggle="collapse" href="#collapseExample" aria-expanded="false"
    ...
    if ($resultGames->num_rows > 0) {
        while ($row = $resultGames->fetch_assoc()) {
            ...
            <div class="col-lg-4 col-sm-6 text-center games">
                <a href="index.php?site=show_game&id=<?php echo $row["id"] ?>"><img class="img-responsive img-center"
                                                                                    src=<?php echo $row["bild_path"]; ?> alt=<?php echo $row["name"] ?>></a>

                <h3> <?php echo GameNameKuerzen($row["name"]); ?> </h3>

                <p> Preis: <?php echo $row["price"]; ?> Fr. </p>
                <a href="sql/warenkorb.php?id=<?php echo $row["id"] ?>">In den Warenkorb<img
