...
<div class="row">
    <div class="col-lg-12">
        ...
        <form method="post" action="sql/user_settings.php" name="Registrierungsformular">
            ...
            <p>Name: </p><input type="text" name="name" class="form-control" value=<?php echo $name; ?> required="true" onkeypress="return textonly(event);"/><br />
            <p>Vorname: </p><input type="text" name="vorname" class="form-control" value=<?php echo $vorname; ?> required="true" onkeypress="return textonly(event);"/><br>
            ...
            <p>Ort: </p><input type="text" name="ort" class="form-control" value=<?php echo $ort; ?> required="true" onkeypress="return textonly(event);"/><br>
